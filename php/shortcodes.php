...
add_action('init', function(){
    ...
    add_shortcode(
        'gmuw_masonanalytics_shortcode', //shortcode label (use as the shortcode on the site)
        'gmuw_masonanalytics_shortcode' //callback function
    );
...
function gmuw_masonanalytics_shortcode(){
